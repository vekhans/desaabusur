  ...
  <div class="container text-center">
    <a href="{{route('beranda')}}">
      <div class="logo-container" >
        <div class="logo">
          <img src="{{asset('media/veky.ico')}}" class="img-responsive" style="width: 100px; height: 80px; top: 10px; left: 10px; border-radius: 30%;" alt="icon veky">
        </div>         
      </div>
    </a> 
  </div>
...
<body>
  <header>
    <div class="bottom-menu">
      <div class="container text-center">
        <a class="menu-nav-icon  " href="#"><i class="ion-navicon navbar-left" ></i></a>
      ...
      <div class="row">
        <div class="container text-center">
          <a href="{{route('beranda')}}">
            <div class="logo-container" >
              <div class="logo">
                <img src="{{asset('media/veky.png')}}" class="logo img-responsive" target="_blank" style="width: 100px; height: 80px; top: 10px; left: 10px; border-radius: 30%;" alt="icon veky">
              </div>
            </div>
          </a>
          ...
          <p class="font-9 pt-5 mtb-5">
            Modify with <i class="ion-heart" aria-hidden="true"></i> by <a href="https://desa.com" target="_blank">DESA</a>
          </p> 
        </div>
      </div>
    </div>
